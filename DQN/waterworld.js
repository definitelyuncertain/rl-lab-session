...
var Agent = function() {
  ...
  this.event_hist = [];
  this.evi = 0;
  this.event_hist_size = 100;
  this.n_apples_hist = 0;
...
Agent.prototype = {
  ...
  {
    if(event_type == 1)
        this.n_apples_hist += 1;
    if(this.event_hist.length >= this.event_hist_size)
    {
        if(this.event_hist[this.evi] == 1)
            this.n_apples_hist -= 1;
    }
    this.event_hist[this.evi] = event_type;
    this.evi = ((this.evi+1) % this.event_hist_size);
  }
}
